...
use Victoria\AppBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VictoriaAppBundle:Role')->findAll();
        
        $menu = $session->get('_menu');
        return $this->render('VictoriaAppBundle:Role:index.html.twig', array(
            'entities' => $entities, 'menu' => $menu,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('VictoriaAppBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VictoriaAppBundle:Role')->find($id);
        ...
        return $this->render('VictoriaAppBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('VictoriaAppBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
